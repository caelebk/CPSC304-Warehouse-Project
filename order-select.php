<html>
    <head>
        <title>Order Selection/Projection</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    </head>
    <body class = 'text-center'>
        <h1 class='display-4 text-center py-3 bg-dark text-light'> Order Selection/Projection </h1>
        ...
        <p>To select multiple attributes use ", " to separate. Leave the WHERE textbox empty for projection. For strings in the WHERE textbox, please use single quotations eg. cname = 'example@gmail.com'</p>
        <form method="GET" action="order-select.php"> 
