<html>
    <header>
        <title>Product Aggregation with Group By</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    </header>

    <body class="text-center">
    <h1 class='display-4 py-3 bg-dark text-light'> Product Aggregation with Group By </h1>
            ...
            <h5>Find the max stock for each company</h5>
            <hr />
            <form method="GET" action="product-AggregationGB.php"> 
            <input type="hidden" id="aggregationGBRequest" name="aggregationGBRequest">
            Select: MAX(stock), companyName <br /><br />
            From: ProductStock <br /><br />
            Group By: companyName <br /><br />
            <input type="submit" value="Submit" name="groupByQuery"></p>
        </form>
    ...
    function handleGroupByRequest(){
        $query = "SELECT companyName, MAX(stock) FROM ProductStock GROUP BY companyName";
        $result = executePlainSQL($query);
        printResult($result, array("Company Name", "Max stock"), "GroupBy");
    }
    ...
    function handleGETRequest(){
        if (connectToDB()) {
            if (array_key_exists('groupByQuery', $_GET)) {
    ...
    if (isset($_GET['aggregationGBRequest'])) {
        handleGETRequest();
    }
